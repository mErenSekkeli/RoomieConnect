...
import com.erensekkeli.roomieconnect.guitools.BottomSheetFragment
import com.erensekkeli.roomieconnect.R
import com.erensekkeli.roomieconnect.databinding.ActivitySignUpBinding
    ...
    fun signUp(view: View): Boolean{
        ...
        auth.createUserWithEmailAndPassword(email, password).addOnSuccessListener {
            ...
            if(selectedImage != null && imageReference != null) {
                ...
                postMap["surname"] = binding.surnameInput.text.toString()
                postMap["email"] = auth.currentUser!!.email!!
                postMap["gradeYear"] = binding.gradeYear.text.toString()
                postMap["status"] = when(binding.statusSpinner.selectedItem.toString()){
                    R.string.status_0.toString() -> 0
                    R.string.status_1.toString() -> 1
                    R.string.status_2.toString() -> 2
                    else -> 0
                }
